...
## Project Structure
    ...
    ├── testapiautoconnecto_72484  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_72484`
...
2. Clone this repo and `cd testapiautoconnecto_72484`
